...
//creamos un producto para una empresa en especifico
...
//visualizamos todos los productos, antes los obtenemos del servidor
function verProductos(idEmpresa){
    $('#pro'+idEmpresa).hide();
    $('#restPro'+idEmpresa).show();
    axios({
        method :'GET',
...
//obtenemos todos los productos de una empresa en especifica
...
//actualizamos un producto en especifico
...
//obtenemos los datos del productos para editarlos
